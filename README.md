...
# Color theme used by the theme (theme will use ${color_theme}.css file, generated by SASS or SCSS file with the same name). Defaults to "default".
color_theme = "my-awesome-theme"
